...
<body>
    <div style="width:100%;max-width:400px;text-align:center">
        ...
        <div style="font-size:72px;font-weight:800;letter-spacing:-.04em;color:#F2B81D;line-height:1;margin-bottom:16px">500</div>
        <h1 style="font-size:22px;font-weight:700;margin:0 0 10px;color:#1C1917">Erreur serveur</h1>
        <p style="font-size:15px;color:#78716C;margin:0 0 32px;line-height:1.55">Quelque chose s'est mal passé. Réessaie dans quelques instants.</p>
